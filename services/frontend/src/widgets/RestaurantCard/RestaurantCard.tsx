  ...
  <div className=" flex flex-col  gap-4 w-[90%] self-center sm:w-[45%] md:w-48 xl:w-56 2xl:w-64">
    <div className="flex flex-col gap-2 lg:gap-4">
      ...
      <div className=" flex flex-col gap-2 lg:gap-5">
        <span className=" text-black-600 text-left w-full font-bold text-base md:text-lg md:leading-5 lg:text-xl lg:leading-5 xl:text-2xl xl:leading-5  break-words h-14 flex items-center line-clamp-2 leading-5">
          {name}
        </span>
        <div className=" text-orange-400 flex flex-row gap-2 items-center h-12 md:h-16">
